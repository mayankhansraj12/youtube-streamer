...
const Signup = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await axios.post(`${SERVER_URL}/api/auth/signup`, { username, email, password });
    ...
    return (
        <div className="min-h-screen bg-[#0f0f0f] flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md bg-[#1a1a1a] p-8 rounded-2xl border border-white/10 shadow-2xl">
                ...
                <p className="text-gray-400 text-center mb-8">Join the streaming experience</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold py-3 rounded-xl hover:opacity-90 transition-opacity mt-2">
                        Sign Up
                    </button>
                </form>
